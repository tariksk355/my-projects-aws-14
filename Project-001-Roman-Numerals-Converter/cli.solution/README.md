...
pip3 install flask
cd /home/ec2-user
FOLDER="https://raw.githubusercontent.com/tariksk355/my-projects-aws-14/main/Project-001-Roman-Numerals-Converter"
wget ${FOLDER}/app.py
...
```
```bash
aws ec2 run-instances --image-id $LATEST_AMI --count 1 --instance-type t2.micro --key-name tarkovski --security-group-ids sg-08abf66a772bef7ca --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=roman_numbers}]' --user-data file:///home/ec2-user/userdata.sh
or
